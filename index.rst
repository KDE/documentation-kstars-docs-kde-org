...
Apart from this online version, The KStars handbook can be found in your $(KDEDIR)/share/doc/HTML/<lang>/kstars/
directory. You can also easily access it from the Help menu, or by pressing the [F1] key.
...
|                   :ref:`user_manual`                   |
|                                                        |
| Discover features of KStars through an  online manual. |
|                                                        |
+--------------------------------------------------------+
...
.. |user-manual-img| image:: /images/kstars_main.png   
