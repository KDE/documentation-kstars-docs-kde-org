...
.. toctree::
   ...
   user_manual/using-kstars
   user_manual/config
   user_manual/commands
   user_manual/ekos
   user_manual/fitsviewer
   user_manual/tools
   user_manual/dumpmode
   user_manual/indi
   user_manual/faq
   user_manual/astroinfo
   user_manual/credits
   user_manual/doc-index

**List of Tables**

  3.1. :ref:`Stars Catalogs <catalogs-stars>`

  3.2. :ref:`Deep-sky objects Catalogs <catalogs-deepsky-objects>`

  5.1. :ref:`Index Files <ekos-align-index-files>`

  9.1. :ref:`INDI State color code <indi-state-color>`
